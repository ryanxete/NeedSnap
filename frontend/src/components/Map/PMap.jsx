  ...
  return (
        <div className="mapouter">
            <div className="gmap_canvas">
                <iframe width="100%" height="488" id="gmap_canvas" src="https://maps.google.com/maps?q=5403,kirbyDr,Houston,TX,77005&t=&z=13&ie=UTF8&iwloc=&output=embed" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0">
                </iframe>
            </div>
        </div>
  )
